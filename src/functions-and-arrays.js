...
let num1 = 2;
let num2 = 2;
console.log("1. Bigger number: ",maxOfTwoNumbers(num1, num2));

function maxOfTwoNumbers(n1,n2) {
  if(n1 != n2){  //won't enter if equal numbers
    if (n1 > n2){
      return n1;
    }else{
      return n2;
...
console.log("2. Longest word: ",findLongestWord(words));
...
console.log("3.1 Sum: ",sumNumbers(numbers));
...
console.log("3.2 Mixed sum: ",sum(mixedArr));
...
console.log("4.1 Average: ",averageNumbers(numbersAvg));
...
console.log("4.2 Array of strings average length: ",averageWordLength(wordsArr));

function averageWordLength(wordsArr) { 
  let wordsLength = [];

  wordsArr.forEach(function (current){
    wordsLength.push(current.length);
  });
